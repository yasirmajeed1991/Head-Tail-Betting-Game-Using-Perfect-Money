...
?>			
			...
			<div id="stat_box">&bull; Bet History</div>				<div id="box">
				<div class="cell_280"><b>User Name</b></div>
				...
				<div class="clear"></div>
						...
						<?php 
						$sql = "SELECT * FROM bhistory ORDER BY datetime DESC ";
	 ...
	 $status = $row[status];
		if($status=='win'){
			...
			$color = 'red';
					...
					<div class="cell_280"><font color='<?php echo $color?>'><a href="users.php"><?php echo $row[username];?></a></font></div>
